...
public class PantallaRtaOperador extends javax.swing.JFrame {
    ...
    private int respuestaConfirmacion;
    ...
    public void mostrarDatosLlamadayValidaciones(List<Validacion> cad){
        ...
        comboAccion.addItem("Comunicar saldo");
        comboAccion.addItem("Dar de baja tarjeta");
        comboAccion.addItem("Denunciar robo");
    ...
    public void tomarRespuestaOperador(){
        ...
        datosPantalla[0]= txtRtaOperador.getText();
    ...
    //Metodo encargo de tomar la confirmacion en pantalla.
    public void tomarConfirmacion(int respuestaConfirmacion){
        //Condicional encargado de verificar que la respuesta a la confirmacion sea "si".
